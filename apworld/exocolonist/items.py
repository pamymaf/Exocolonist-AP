...
ITEM_CLASSIFICATIONS = {
  ...
  "Bobberfruit": ItemClassification.filler,
  "Medicinal Roots": ItemClassification.filler,
  "Xeno Egg": ItemClassification.filler,
  "Yellow Flower": ItemClassification.filler,
  "Mushwood Log": ItemClassification.filler,
  "Crystal Cluster": ItemClassification.filler,
  "Strange Device": ItemClassification.filler,
  "Progressive Year": ItemClassification.progression,
  "Experience": ItemClassification.filler,
  "Cake": ItemClassification.filler,
